package com.king.wechat.qrcode.app.huawei
...
import com.king.zxing.analyze.HuaweiAnalyzer
import com.king.zxing.analyze.QRCodeAnalyzer

class HuaweiQrCodeActivity: BarcodeCameraScanActivity() {
    ...
    override fun createAnalyzer(): Analyzer<Result>? {
        ...
        val huaweiAnalyzer = HuaweiAnalyzer(decodeConfig)
        huaweiAnalyzer.mContext = this
        return huaweiAnalyzer
    }
