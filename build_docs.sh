...
GITHUB_URL=https://github.com/jenly1314/WeChatQRCode/
echo $GITHUB_URL
...
sed -i "s|](opencv|](${GITHUB_URL}blob/master/opencv|g" docs/index.md
sed -i "s|](wechat|](${GITHUB_URL}blob/master/wechat|g" docs/index.md
